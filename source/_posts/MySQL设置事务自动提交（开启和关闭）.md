---
title: MySQL设置事务自动提交（开启和关闭）
categories:
  - MySql
date: 2026-03-15 23:06:10
tags:
---
> 🔗 原文链接： [http://c.biancheng.net/view/7291.ht...](http://c.biancheng.net/view/7291.html)
...
下面我们关闭事务自动提交，模拟银行转账。 使用 SET autocommit 语句关闭事务自动提交，且张三转给李四 500 元，SQL 语句和运行结果如下：
...
结果显示，张三和李四的余额是事务执行前的数据。  下面在之前的窗口中使用 COMMIT 语句提交事务，并查询 bank 数据表的数据，如下所示：
